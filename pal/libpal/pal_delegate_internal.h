/* pal_delegate_internal
 * removed support for VC6 and DOS.
 * moved some of the functionality to pal_delegate.h
 */
/*
 *	Delegate.h
 *  CoreGame
...
// 24-Dec-04 1.4  * Added palDelegateMemento, to allow collections of disparate delegates.
...
#ifndef LIBPAL_PAL_DELEGATE_INTERNAL_H_
#define LIBPAL_PAL_DELEGATE_INTERNAL_H_
...
namespace _pal_delegate_internal {
...
// palDelegateMemento -- an opaque structure which can hold an arbitary delegate.
...
//				palDelegateMemento - Safe version
//
...
//				palDelegateMemento - Evil version
//
// For compilers where data pointers are at least as big as code pointers, it is
// possible to store the function pointer in the this pointer, using another
// horrible_cast. In this case the palDelegateMemento implementation is simple:
...
public:
#if !defined(FASTDELEGATE_USESTATICFUNCTIONHACK)
	palDelegateMemento() : m_pthis(0), m_pFunction(0), m_pStaticFunction(0) {};
	void clear() {
		m_pthis=0; m_pFunction=0; m_pStaticFunction=0;
	}
#else
	palDelegateMemento() : m_pthis(0), m_pFunction(0) {};
	void clear() {	m_pthis=0; m_pFunction=0;	}
#endif
public:
#if !defined(FASTDELEGATE_USESTATICFUNCTIONHACK)
	inline bool IsEqual (const palDelegateMemento &x) const{
	...
	inline bool IsLess(const palDelegateMemento &right) const {
	...
	{ return m_pthis==0 && m_pFunction==0; }
public:
	palDelegateMemento & operator = (const palDelegateMemento &right)	 {
		SetMementoFrom(right);
		return *this;
	}
	inline bool operator <(const palDelegateMemento &right) {
		return IsLess(right);
	}
	inline bool operator >(const palDelegateMemento &right) {
		return right.IsLess(*this);
	}
	palDelegateMemento (const palDelegateMemento &right)	:
		...
		{}
protected:
	void SetMementoFrom(const palDelegateMemento &right)  {
...
//						ClosurePtr<>
//
// A private wrapper class that adds function signatures to palDelegateMemento.
...
class ClosurePtr : public palDelegateMemento {
public:
...
public:
	...
	inline void CopyFrom (DerivedClass *pParent, const palDelegateMemento &x) {
		SetMementoFrom(x);
...
// support static_cast between void * and function pointers.
	...
	template< class DerivedClass >
	inline void CopyFrom (DerivedClass *pParent, const palDelegateMemento &right) {
		SetMementoFrom(right);
	}
	// For static functions, the 'static_function_invoker' class in the parent
	// will be called. The parent then needs to call GetStaticFunction() to find out
...
public:
	...
	typedef palDelegate0 type;

	// Construction and comparison functions
	palDelegate0() { clear(); }
	palDelegate0(const palDelegate0 &x) {
		m_Closure.CopyFrom(this, x.m_Closure); }
	void operator = (const palDelegate0 &x)  {
		m_Closure.CopyFrom(this, x.m_Closure); }
	bool operator ==(const palDelegate0 &x) const {
	...
	palDelegate0(Y *pthis, DesiredRetType (X::* function_to_bind)() ) {
	...
	template < class X, class Y >
	palDelegate0(const Y *pthis, DesiredRetType (X::* function_to_bind)() const) {
	...
	palDelegate0(DesiredRetType (*function_to_bind)() ) {
		bind(function_to_bind); }
	// for efficiency, prevent creation of a temporary
	void operator = (DesiredRetType (*function_to_bind)() ) {
		bind(function_to_bind); }
	inline void bind(DesiredRetType (*function_to_bind)()) {
		m_Closure.bindstaticfunc(this, &palDelegate0::InvokeStaticFunction,
			function_to_bind); }
	// Invoke the delegate
...
public:
	...
	// Conversion to and from the palDelegateMemento storage class
	const palDelegateMemento & GetMemento() { return m_Closure; }
	void SetMemento(const palDelegateMemento &any) { m_Closure.CopyFrom(this, any); }
...
public:
	// Typedefs to aid generic programming
	typedef palDelegate1 type;

	// Construction and comparison functions
	palDelegate1() { clear(); }
	palDelegate1(const palDelegate1 &x) {
		m_Closure.CopyFrom(this, x.m_Closure); }
	void operator = (const palDelegate1 &x)  {
		m_Closure.CopyFrom(this, x.m_Closure); }
	bool operator ==(const palDelegate1 &x) const {
		return m_Closure.IsEqual(x.m_Closure);	}
	bool operator !=(const palDelegate1 &x) const {
		return !m_Closure.IsEqual(x.m_Closure); }
	bool operator <(const palDelegate1 &x) const {
	...
	// Binding to non-const member functions
	template < class X, class Y >
	palDelegate1(Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1) ) {
		m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind); }
	template < class X, class Y >
	...
	// Binding to const member functions.
	template < class X, class Y >
	palDelegate1(const Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1) const) {
		m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);	}
	template < class X, class Y >
	...
	// Static functions. We convert them into a member function call.
	// This constructor also provides implicit conversion
	palDelegate1(DesiredRetType (*function_to_bind)(Param1 p1) ) {
		bind(function_to_bind); }
	// for efficiency, prevent creation of a temporary
	void operator = (DesiredRetType (*function_to_bind)(Param1 p1) ) {
		bind(function_to_bind); }
	inline void bind(DesiredRetType (*function_to_bind)(Param1 p1)) {
		m_Closure.bindstaticfunc(this, &palDelegate1::InvokeStaticFunction,
			function_to_bind); }
	// Invoke the delegate
...
public:
	// Typedefs to aid generic programming
	typedef palDelegate2 type;

	// Construction and comparison functions
	palDelegate2() { clear(); }
	palDelegate2(const palDelegate2 &x) {
		m_Closure.CopyFrom(this, x.m_Closure); }
	void operator = (const palDelegate2 &x)  {
		m_Closure.CopyFrom(this, x.m_Closure); }
	bool operator ==(const palDelegate2 &x) const {
		return m_Closure.IsEqual(x.m_Closure);	}
	bool operator !=(const palDelegate2 &x) const {
		return !m_Closure.IsEqual(x.m_Closure); }
	bool operator <(const palDelegate2 &x) const {
	...
	// Binding to non-const member functions
	template < class X, class Y >
	palDelegate2(Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2) ) {
		m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind); }
	template < class X, class Y >
	...
	// Binding to const member functions.
	template < class X, class Y >
	palDelegate2(const Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2) const) {
		m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);	}
	template < class X, class Y >
	...
	// Static functions. We convert them into a member function call.
	// This constructor also provides implicit conversion
	palDelegate2(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2) ) {
		bind(function_to_bind); }
	// for efficiency, prevent creation of a temporary
	...
	inline void bind(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2)) {
		m_Closure.bindstaticfunc(this, &palDelegate2::InvokeStaticFunction,
			function_to_bind); }
	// Invoke the delegate
...
public:
	// Typedefs to aid generic programming
	typedef palDelegate3 type;

	// Construction and comparison functions
	palDelegate3() { clear(); }
	palDelegate3(const palDelegate3 &x) {
		m_Closure.CopyFrom(this, x.m_Closure); }
	void operator = (const palDelegate3 &x)  {
		m_Closure.CopyFrom(this, x.m_Closure); }
	bool operator ==(const palDelegate3 &x) const {
		return m_Closure.IsEqual(x.m_Closure);	}
	bool operator !=(const palDelegate3 &x) const {
		return !m_Closure.IsEqual(x.m_Closure); }
	bool operator <(const palDelegate3 &x) const {
	...
	// Binding to non-const member functions
	template < class X, class Y >
	palDelegate3(Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3) ) {
		m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind); }
	template < class X, class Y >
	...
	// Binding to const member functions.
	template < class X, class Y >
	palDelegate3(const Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3) const) {
		m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);	}
	template < class X, class Y >
	...
	// Static functions. We convert them into a member function call.
	// This constructor also provides implicit conversion
	palDelegate3(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3) ) {
		bind(function_to_bind); }
	// for efficiency, prevent creation of a temporary
	...
	inline void bind(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3)) {
		m_Closure.bindstaticfunc(this, &palDelegate3::InvokeStaticFunction,
			function_to_bind); }
	// Invoke the delegate
...
public:
	// Typedefs to aid generic programming
	typedef palDelegate4 type;

	// Construction and comparison functions
	palDelegate4() { clear(); }
	palDelegate4(const palDelegate4 &x) {
		m_Closure.CopyFrom(this, x.m_Closure); }
	void operator = (const palDelegate4 &x)  {
		m_Closure.CopyFrom(this, x.m_Closure); }
	bool operator ==(const palDelegate4 &x) const {
		return m_Closure.IsEqual(x.m_Closure);	}
	bool operator !=(const palDelegate4 &x) const {
		return !m_Closure.IsEqual(x.m_Closure); }
	bool operator <(const palDelegate4 &x) const {
	...
	// Binding to non-const member functions
	template < class X, class Y >
	palDelegate4(Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4) ) {
		m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind); }
	template < class X, class Y >
	...
	// Binding to const member functions.
	template < class X, class Y >
	palDelegate4(const Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4) const) {
		m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);	}
	template < class X, class Y >
	...
	// Static functions. We convert them into a member function call.
	// This constructor also provides implicit conversion
	palDelegate4(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4) ) {
		bind(function_to_bind); }
	// for efficiency, prevent creation of a temporary
	...
	inline void bind(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4)) {
		m_Closure.bindstaticfunc(this, &palDelegate4::InvokeStaticFunction,
			function_to_bind); }
	// Invoke the delegate
...
public:
	// Typedefs to aid generic programming
	typedef palDelegate5 type;

	// Construction and comparison functions
	palDelegate5() { clear(); }
	palDelegate5(const palDelegate5 &x) {
		m_Closure.CopyFrom(this, x.m_Closure); }
	void operator = (const palDelegate5 &x)  {
		m_Closure.CopyFrom(this, x.m_Closure); }
	bool operator ==(const palDelegate5 &x) const {
		return m_Closure.IsEqual(x.m_Closure);	}
	bool operator !=(const palDelegate5 &x) const {
		return !m_Closure.IsEqual(x.m_Closure); }
	bool operator <(const palDelegate5 &x) const {
	...
	// Binding to non-const member functions
	template < class X, class Y >
	palDelegate5(Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5) ) {
		m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind); }
	template < class X, class Y >
	...
	// Binding to const member functions.
	template < class X, class Y >
	palDelegate5(const Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5) const) {
		m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);	}
	template < class X, class Y >
	...
	// Static functions. We convert them into a member function call.
	// This constructor also provides implicit conversion
	palDelegate5(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5) ) {
		bind(function_to_bind); }
	// for efficiency, prevent creation of a temporary
	...
	inline void bind(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5)) {
		m_Closure.bindstaticfunc(this, &palDelegate5::InvokeStaticFunction,
			function_to_bind); }
	// Invoke the delegate
...
public:
	// Typedefs to aid generic programming
	typedef palDelegate6 type;

	// Construction and comparison functions
	palDelegate6() { clear(); }
	palDelegate6(const palDelegate6 &x) {
		m_Closure.CopyFrom(this, x.m_Closure); }
	void operator = (const palDelegate6 &x)  {
		m_Closure.CopyFrom(this, x.m_Closure); }
	bool operator ==(const palDelegate6 &x) const {
		return m_Closure.IsEqual(x.m_Closure);	}
	bool operator !=(const palDelegate6 &x) const {
		return !m_Closure.IsEqual(x.m_Closure); }
	bool operator <(const palDelegate6 &x) const {
	...
	// Binding to non-const member functions
	template < class X, class Y >
	palDelegate6(Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6) ) {
		m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind); }
	template < class X, class Y >
	...
	// Binding to const member functions.
	template < class X, class Y >
	palDelegate6(const Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6) const) {
		m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);	}
	template < class X, class Y >
	...
	// Static functions. We convert them into a member function call.
	// This constructor also provides implicit conversion
	palDelegate6(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6) ) {
		bind(function_to_bind); }
	// for efficiency, prevent creation of a temporary
	...
	inline void bind(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6)) {
		m_Closure.bindstaticfunc(this, &palDelegate6::InvokeStaticFunction,
			function_to_bind); }
	// Invoke the delegate
...
public:
	// Typedefs to aid generic programming
	typedef palDelegate7 type;

	// Construction and comparison functions
	palDelegate7() { clear(); }
	palDelegate7(const palDelegate7 &x) {
		m_Closure.CopyFrom(this, x.m_Closure); }
	void operator = (const palDelegate7 &x)  {
		m_Closure.CopyFrom(this, x.m_Closure); }
	bool operator ==(const palDelegate7 &x) const {
		return m_Closure.IsEqual(x.m_Closure);	}
	bool operator !=(const palDelegate7 &x) const {
		return !m_Closure.IsEqual(x.m_Closure); }
	bool operator <(const palDelegate7 &x) const {
	...
	// Binding to non-const member functions
	template < class X, class Y >
	palDelegate7(Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7) ) {
		m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind); }
	template < class X, class Y >
	...
	// Binding to const member functions.
	template < class X, class Y >
	palDelegate7(const Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7) const) {
		m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);	}
	template < class X, class Y >
	...
	// Static functions. We convert them into a member function call.
	// This constructor also provides implicit conversion
	palDelegate7(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7) ) {
		bind(function_to_bind); }
	// for efficiency, prevent creation of a temporary
	...
	inline void bind(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7)) {
		m_Closure.bindstaticfunc(this, &palDelegate7::InvokeStaticFunction,
			function_to_bind); }
	// Invoke the delegate
...
public:
	// Typedefs to aid generic programming
	typedef palDelegate8 type;

	// Construction and comparison functions
	palDelegate8() { clear(); }
	palDelegate8(const palDelegate8 &x) {
		m_Closure.CopyFrom(this, x.m_Closure); }
	void operator = (const palDelegate8 &x)  {
		m_Closure.CopyFrom(this, x.m_Closure); }
	bool operator ==(const palDelegate8 &x) const {
		return m_Closure.IsEqual(x.m_Closure);	}
	bool operator !=(const palDelegate8 &x) const {
		return !m_Closure.IsEqual(x.m_Closure); }
	bool operator <(const palDelegate8 &x) const {
	...
	// Binding to non-const member functions
	template < class X, class Y >
	palDelegate8(Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7, Param8 p8) ) {
		m_Closure.bindmemfunc(detail::implicit_cast<X*>(pthis), function_to_bind); }
	template < class X, class Y >
	...
	// Binding to const member functions.
	template < class X, class Y >
	palDelegate8(const Y *pthis, DesiredRetType (X::* function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7, Param8 p8) const) {
		m_Closure.bindconstmemfunc(detail::implicit_cast<const X*>(pthis), function_to_bind);	}
	template < class X, class Y >
	...
	// Static functions. We convert them into a member function call.
	// This constructor also provides implicit conversion
	palDelegate8(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7, Param8 p8) ) {
		bind(function_to_bind); }
	// for efficiency, prevent creation of a temporary
	...
	inline void bind(DesiredRetType (*function_to_bind)(Param1 p1, Param2 p2, Param3 p3, Param4 p4, Param5 p5, Param6 p6, Param7 p7, Param8 p8)) {
		m_Closure.bindstaticfunc(this, &palDelegate8::InvokeStaticFunction,
			function_to_bind); }
	// Invoke the delegate
...
#endif //_PAL_DELEGATE_INTERNAL_H__
